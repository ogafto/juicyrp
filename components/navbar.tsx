    ...
    <>
      <div className="fixed top-0 left-0 w-full z-50 pointer-events-none">
        <motion.nav 
          ...
          className={`w-full flex items-center justify-between px-6 md:px-12 xl:px-[300px] transition-all duration-300 pointer-events-auto ${
            isScrolled ? "py-[12px] xl:py-[16px] bg-[#0F0905]/85 backdrop-blur-lg" : "py-[24px] xl:py-[32px] bg-transparent"
          }`}
        >
        ...
        <div className="flex xl:absolute xl:left-1/2 xl:top-1/2 xl:-translate-x-1/2 xl:-translate-y-1/2 z-50">
          <Link href="/" className="cursor-pointer">
            <img src="/logo.png" alt="JuicyRP Logo" className="w-[48px] h-[48px] xl:w-[64px] xl:h-[64px] object-contain transition-all duration-300 hover:scale-110" />
          </Link>
        </div>
        ...
        <div className="flex xl:hidden items-center z-50">
          <button
            ...
            className="text-white hover:text-[#FF6A00] transition-colors p-2 -mr-2"
          >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-[32px] text-center w-full">
              ...
              <div className="flex flex-col items-center gap-[24px] mt-[48px] w-full max-w-[250px]">
                <button
                ...
                <Link href="https://discord.gg/juicyrp" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FF6A00] transition-all duration-300 hover:scale-110 cursor-pointer flex items-center justify-center p-2">
